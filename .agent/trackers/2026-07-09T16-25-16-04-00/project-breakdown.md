...
Refresh the repo-local `.agent` breakdown for `LuminaryLabs-Publish/PhantomCommand`, keep runtime source untouched, and align the next implementation handoff around source-profile central sync plus `GameHost` fixture readback.
