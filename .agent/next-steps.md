...
- [ ] Prove ring count 7, lane count 4, generated pad count, starter ally count, tower catalog, wave queue shape, build accept/reject, order action, wave start, win/loss flags, and GameHost legacy compatibility.
